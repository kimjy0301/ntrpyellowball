      ...
      <>
        <div className="w-96 flex relative flex-col md:shadow-lg justify-center border-yellow-1 border-2  rounded-md items-center p-4 bg-white mx-1 my-1 shadow-lg md:max-w-xs1 transition-all">
          ...
          <div className="flex">
            <div
              onClick={() => onClickYes()}
              className="bg-blue-500 py-2 px-10 hover:bg-blue-700 cursor-pointer transition-all mx-1 shadow-lg rounded"
            >
              <span className="text-white text-5xl font-extrabold">O</span>
            </div>
            <div
              onClick={() => onClickNo()}
              className=" bg-red-500 py-2 px-10 hover:bg-red-700 cursor-pointer transition-all mx-1 shadow-lg rounded"
            >
